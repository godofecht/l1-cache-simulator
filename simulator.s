	...
	.globl	__Z13compiler_infov             ; -- Begin function _Z13compiler_infov
	.p2align	2
__Z13compiler_infov:                    ; @_Z13compiler_infov
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #48
...
l_.str:                                 ; @.str
	.asciz	"--- Compiler Information ---"

l_.str.1:                               ; @.str.1
	.asciz	"GNU C/C++ Compiler (GCC)"
